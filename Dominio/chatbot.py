...
def diccionario_accidentes(texto):
    ...
    robo = "robo", "sustraer", "hurtar", "robar", "sustraccion", "hurto", "delito", "delincuente", "ladrón", "coche robado", "robado"
    accidente = "caído", "accidente", "choque", "colision", "impacto", "accidentado", "accidentado", "accidentada", "accidentados", "accidentadas", "choque frontal", "choque lateral", "colision frontal", "colision lateral"
